...
4) **FastSurferVINN**:
   ...
   - **FastSurfer version used**: Docker container of version 2.1.1 (https://github.com/Deep-MI/FastSurfer/releases/tag/v2.1.1) with the `--seg_only` flag running on GPU. 
